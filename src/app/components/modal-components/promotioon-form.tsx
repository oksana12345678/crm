...
import { createPromotion, getCompany } from '@/lib/app';
import InputField from '../common/input-field';
import LogoUploader from '../common/logo-uploader';
...
function PromotionForm({ companyId, onSubmit }: PromotionFormProps) {
